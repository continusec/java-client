 ...
 * of the entries. See {@link VerifiableLog#verifyEntries(LogTreeHead, LogTreeHead, VerifiableEntryFactory, LogAuditor)}.
 */
public interface LogAuditor {
	/**
	 * Called by {@link VerifiableLog#verifyEntries(LogTreeHead, LogTreeHead, VerifiableEntryFactory, LogAuditor)} as each log entry is encountered.
