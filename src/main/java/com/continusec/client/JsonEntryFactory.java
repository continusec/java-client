...
/**
 * Factory that produces {@link JsonEntry} instances upon request.
 */
public class JsonEntryFactory implements VerifiableEntryFactory {
	private static final JsonEntryFactory self = new JsonEntryFactory();
	 ...
	 */
	public JsonEntry createFromBytes(byte[] bytes) {
